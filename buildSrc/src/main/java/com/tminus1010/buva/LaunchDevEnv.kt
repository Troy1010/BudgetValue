...
open class LaunchDevEnv @Inject constructor(adbAbsolutePath: String, nameOfDevEnv: String) : Exec() {
    init {
        commandLine = listOf(adbAbsolutePath, "shell", "am", "instrument", "-w", "-m", "-e", "debug", "false", "-e", "class", "com.tminus1010.buva.devEnvs.$nameOfDevEnv", "com.tminus1010.buva.test/com.tminus1010.buva.core_testing.CustomTestRunner")
