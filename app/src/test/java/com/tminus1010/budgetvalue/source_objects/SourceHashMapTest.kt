...
class SourceHashMapTest {
    ...
    fun put() {
        ...
        assertEquals(10, sourceHashMap.itemObservableMap.value[0]!!.value)
    }
    ...
    fun putAll() {
        ...
        Thread.sleep(1000) // TODO("use RxThreadsRule")
        assertEquals(10, sourceHashMap.itemObservableMap.value[0]!!.value)
        assertEquals(30, sourceHashMap.itemObservableMap.value[3]!!.value)
        assertEquals(90, sourceHashMap.itemObservableMap.value[9]!!.value)
    }
