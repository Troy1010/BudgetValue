...
class CategoryAmountsAndTotalWithValidation(
    ...
    total: BigDecimal,
    private val caValidation: (Category, BigDecimal?) -> Validation,
    private val defaultAmountValidation: (BigDecimal?) -> Validation,
) : CategoryAmountsAndTotal.FromTotal(categoryAmounts, total) {
    constructor(categoryAmountsAndTotal: CategoryAmountsAndTotal, caValidation: (Category, BigDecimal?) -> Validation, defaultAmountValidation: (BigDecimal?) -> Validation) : this(categoryAmountsAndTotal.categoryAmounts, categoryAmountsAndTotal.total, caValidation, defaultAmountValidation)
