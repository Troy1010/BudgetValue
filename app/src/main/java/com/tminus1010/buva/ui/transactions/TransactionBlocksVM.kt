        ...
        { transactionBlocks, reconciliationSkips, anchorDateOffset ->
            TableViewVMItem(
                recipeGrid = listOf(
                    ...
                    *transactionBlocks.map { TransactionBlockCompletionPresentationModel(it, currentDatePeriod, Domain.shouldSkip(reconciliationSkips, it, anchorDateOffset), reconciliationSkipInteractor).toPresentationModels() }.toTypedArray()
                ),
