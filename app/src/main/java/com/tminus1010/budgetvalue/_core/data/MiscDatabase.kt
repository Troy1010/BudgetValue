...
@Database(
    version = 44,
    entities = [TransactionDTO::class, AccountDTO::class, ReconciliationDTO::class, PlanDTO::class, CategoryDTO::class, BasicReplayDTO::class, BasicFuture::class, TotalFuture::class, Plan::class],
